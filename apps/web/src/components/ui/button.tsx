...
const variants = {
  ...
  /** Signature 135° sage gradient — primary → primary-container. For key CTAs. */
  gradient:
    'bg-gradient-to-br from-primary to-primary-container text-primary-foreground shadow-sm hover:opacity-90',
